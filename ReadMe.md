...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    - useRouteMatch is used as a way to gain access to match data in a component, without having to render a route object. 

2. How would you explain form validation to someone who has never programmed before?

    - Form Validation makes sure that the information being entered both makes sense, and ensures that no required information is left out.

3. In 1-2 sentences, define end to end testing.

    - End to End testing tests a user's experience from first entering a site, to the logical endpoint of the site, to ensure that everything works as it is supposed to.
